...
#
# Requires that VT has been run first
...
tf=r.TFile("VT.root") # open file for read access
if tf.IsZombie():
    print("VT.root not found in current directory, run VTRKnDemo first")
    sys.exit(1)
...
tc.Print("terminal_velocity.png") # or use Projectile.png, etc. to save your canvas
